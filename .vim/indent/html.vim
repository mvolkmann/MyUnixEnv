" From Mark:
" I copied this from /usr/share/vim/vim73/indent/html.vim
" to try to get it to stop indenting continuation lines
" to line up with the first attribute on the previous line.
" After removing all the tab characters, the problem went away.
"
